...
class BERTClass(torch.nn.Module):
    def __init__(self):
        ...
        self.bert_model = model = AutoModel.from_pretrained("roberta-base", output_hidden_states=True, output_attentions=True, return_dict=True)
...
model.load_state_dict(torch.load("ExplainWD_model_RoBERTa_GL_4_Dimension.pt"))
