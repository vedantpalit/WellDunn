...
class BERTClass(torch.nn.Module):
    def __init__(self):
        ...
        self.bert_model = model = AutoModel.from_pretrained(TheClassifier)# BertModel.from_pretrained('bert-base-uncased', return_dict=True)
...
with torch.no_grad():
    ...
    print(example)
    print("***************")
    print(output_attentions.attentions[11][0])

    attentions = output_attentions.attentions[11][0]
